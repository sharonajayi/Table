// import { LookerExtensionSDK } from "@looker/sdk/lib/index.js";
// import lookersdk from 'https://cdn.jsdelivr.net/npm/@looker/sdk@23.8.1/+esm'
//Script for table
var tabletime;
var link2;
var z;
...
//import looker from '@looker/sdk'

//This code block is taking the first head tag and append 2 links with some attributes
var cssId = 'semantic-theming';
...
//Change the font based on the provided font name
...
//defining looker plugin visualization
//adding your own configuration
looker.plugins.visualizations.add({
    create: function (element, config) { //element is the container to render the visualization
        //config is the values of any configuration options

        container = element.appendChild(document.createElement("div")); //append div to element
        container.setAttribute("id", "my-table"); //setting the attribute
        container.setAttribute("class", "tabulator ui teal table");
        if (typeof config.table_font != 'undefined') { //setting the table font
    ...
    updateAsync: function (data, element, config, queryResponse, details, doneRendering) {
        ...
        tabletime = new Tabulator("#my-table", {
            ...
            //             total += number;
            //         });
            //         var footer = column.getFooterElement();
            //         footer.innerHTML = total.toFixed(2);
            //     });
            // },
        });
